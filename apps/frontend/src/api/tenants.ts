...
export const tenantsApi = {
  ...
  create: (name: string, notificationEmail?: string, webhookUrl?: string, username?: string) => 
    client.post('/api/v1/tenants', { name, notificationEmail, webhookUrl, username }).then(r => r.data.data as Tenant),
